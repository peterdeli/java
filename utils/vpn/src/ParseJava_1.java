...
public class ParseJava_1 {
	...
	public static void main( String[] args ){
            ...
            //Checking ...
            //String command = "/home/pdel/bin/vpn.sh";
            //String [] cmd_args = { "/bin/sh", "-c", command, "ebay" };
            
            // Doesn't work! crazy thing
            //String command = "/usr/local/bin/vpnclient";
            //String [] cmd_args = { "/bin/sh", "-c", "eval",  command, "connect", "ebay", "&" };
                        ...
                        default:
                            ...
                            if ( ch == ':' ){
                                ...
                                if ( token == ' ' ){
                                    ...
                                    if ( lastWord.compareTo("Username" ) == 0 ) {
