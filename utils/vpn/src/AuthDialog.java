...
public class AuthDialog extends javax.swing.JDialog {
    ...
    public AuthDialog(vpn3k GUI) {
        ...
        TokenResponse.setBackground(Color.WHITE);
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanel2.setMaximumSize(new java.awt.Dimension(400, 65));
        jPanel2.setMinimumSize(new java.awt.Dimension(400, 65));
        ...
        TokenResponse.setBorder(new javax.swing.border.BevelBorder(javax.swing.border.BevelBorder.LOWERED));
        TokenResponse.setMargin(new java.awt.Insets(0, 5, 0, 5));
        TokenResponse.setMaximumSize(new java.awt.Dimension(234, 25));
        TokenResponse.setMinimumSize(new java.awt.Dimension(234, 25));
        TokenResponse.setPreferredSize(new java.awt.Dimension(224, 25));
        TokenResponse.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                TokenResponseKeyTyped(evt);
            }
        });
    ...
    private void TokenResponseKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TokenResponseKeyTyped
        // Add your handling code here:
        if ( evt.getKeyChar() == evt.VK_ENTER &&  this.ConnectButton.isEnabled( ) ) {
            this.getResponse(evt);
        }
    }//GEN-LAST:event_TokenResponseKeyTyped
     ...
     * private void getResponse(java.awt.event.KeyEvent evt) {
        ...
        char [] tokenChars = TokenResponse.getPassword();
        String tokenString = new String ( tokenChars );
        UI.setTokenPass( tokenString );
        this.dispose();
     
    }
    private void getResponse(java.awt.event.ActionEvent evt) {
        // Add your handling code here:
        UI.setUserID( this.UserID.getText() );
        char [] tokenChars = TokenResponse.getPassword();
        String tokenString = new String ( tokenChars );
